========================================================================
    ACTIVEX 控件 DLL : WebLabVideo 项目概述
========================================================================

控件向导已为 WebLabVideo ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 WebLabVideo ActiveX 控件 DLL 的每个文件的内容。
...
WebLabVideoCtrl.h
    此文件包含 CWebLabVideoCtrl C++ 类的声明。

WebLabVideoCtrl.cpp
    此文件包含 CWebLabVideoCtrl C++ 类的实现。

WebLabVideoPropPage.h
    此文件包含 CWebLabVideoPropPage C++ 类的声明。

WebLabVideoPropPage.cpp
    此文件包含 CWebLabVideoPropPage C++ 类的实现。

CWebLabVideoCtrl.bmp
    此文件包含一个位图，当 CWebLabVideoCtrl 
...
WebLabVideo.lic
    这是用户许可证文件。  此文件必须与控件 DLL 
    出现在相同目录中，这样才能允许在设计时环境中创建该控件的实例。  
    通常您会将此文件与控件一同分发，但您的客户不会将其分发。

/////////////////////////////////////////////////////////////////////////////
其他标准文件：

stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 WebLabVideo.pch 的预编译头 (PCH) 文件和名为 
